...
public class Thumbnail {
	...
	public static Media getLastImageThumbnail(ContentResolver resolver) {
		...
		String selection = MediaColumns.MIME_TYPE + "='image/jpeg' AND "
				+ ImageColumns.BUCKET_ID + '=' + Storage.BUCKET_ID;
		String order = ImageColumns.DATE_TAKEN + " DESC," + BaseColumns._ID
				+ " DESC";
	...
	private static Media getLastVideoThumbnail(ContentResolver resolver) {
		...
		String order = VideoColumns.DATE_TAKEN + " DESC," + BaseColumns._ID
				+ " DESC";
