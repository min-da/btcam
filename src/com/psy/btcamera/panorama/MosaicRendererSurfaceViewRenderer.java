...
public class MosaicRendererSurfaceViewRenderer implements
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		if (mSurfaceCreateListener != null) {
			mSurfaceCreateListener
					.onMosaicSurfaceCreated(MosaicRenderer.init());
		}
	}

	public void setMosaicSurfaceCreateListener(
			MosaicSurfaceCreateListener listener) {
