...
public class MosaicFrameProcessor {
	...
	// Panning rate is in unit of percentage of image content translation /
	// second.
	...
	public void calculateTranslationRate(long now) {
		...
		// percentage with deltaTime.
		mPanningRateX = mTotalTranslationX
				/ (mPreviewWidth / HR_TO_LR_DOWNSAMPLE_FACTOR)
				/ mTotalDeltaTime;
		mPanningRateY = mTotalTranslationY
				/ (mPreviewHeight / HR_TO_LR_DOWNSAMPLE_FACTOR)
				/ mTotalDeltaTime;
