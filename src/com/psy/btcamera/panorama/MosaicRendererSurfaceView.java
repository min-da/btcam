...
public class MosaicRendererSurfaceView extends GLSurfaceView {
	...
	private void initialize(Context context, boolean translucent, int depth,
			int stencil) {
	...
	private void getDisplayOrientation(Context context) {
		...
		mIsLandscapeOrientation = (activity.getRequestedOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
	}
	...
	private static class ConfigChooser implements
		...
		private static final int[] CONFIG_ATTRIBUTES = { EGL10.EGL_RED_SIZE, 4,
		...
		public EGLConfig chooseConfig(EGL10 egl, EGLDisplay display) {
			...
			egl.eglChooseConfig(display, CONFIG_ATTRIBUTES, configs,
					numConfigs, numConfig);
