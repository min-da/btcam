...
public class BluetoothIOControlService {
	...
	private synchronized void setState(int state) {
		...
		mHandler.obtainMessage(BluetoothIOControl.MESSAGE_STATE_CHANGE, state,
				-1).sendToTarget();
	}
	...
	public synchronized void connected(BluetoothSocket socket,
		...
		Message msg = mHandler
				.obtainMessage(BluetoothIOControl.MESSAGE_DEVICE_NAME);
	...
	private void connectionFailed() {
		...
		Message msg = mHandler.obtainMessage(BluetoothIOControl.MESSAGE_TOAST);
		Bundle bundle = new Bundle();
	...
	private class ConnectedThread extends Thread {
		...
		public void run() {
			...
			while (true) {
				try {
					...
					mHandler.obtainMessage(BluetoothIOControl.MESSAGE_READ,
		...
		public void write(byte[] buffer) {
			try {
				...
				mHandler.obtainMessage(BluetoothIOControl.MESSAGE_WRITE, -1,
