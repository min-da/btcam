...
public class IndicatorControlWheelContainer extends IndicatorControlContainer {
	...
	protected void onLayout(boolean changed, int left, int top, int right,
		...
		mShutterButton.layout(right - left - shutterButtonWidth, mCenterY
				- shutterButtonHeight / 2, right - left, mCenterY
				+ shutterButtonHeight - shutterButtonHeight / 2);
	...
	protected void onMeasure(int widthSpec, int heightSpec) {
		...
		if (widthMode == MeasureSpec.UNSPECIFIED) {
			...
			measuredWidth = Math.min(desiredWidth,
		...
		if (heightMode == MeasureSpec.UNSPECIFIED) {
			...
			measuredHeight = Math.min(desiredHeight,
	...
	public void startTimeLapseAnimation(int timeLapseInterval, long startTime) {
		mIndicatorControlWheel.startTimeLapseAnimation(timeLapseInterval,
				startTime);
	}
