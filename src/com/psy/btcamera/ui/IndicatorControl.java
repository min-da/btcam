...
import com.psy.btcamera.CameraSettings;
import com.psy.btcamera.IconListPreference;
import com.psy.btcamera.ListPreference;
...
public abstract class IndicatorControl extends RelativeLayout implements
	...
	ArrayList<AbstractIndicatorButton> mIndicators = new ArrayList<AbstractIndicatorButton>();

	public void setListener(OnPreferenceChangedListener listener) {
		mListener = listener;
		if (mCameraPicker != null)
			mCameraPicker.setListener(listener);
	}
	...
	protected void addControls(String[] keys, String[] otherSettingKeys) {
		...
		if (otherSettingKeys != null) {
			addOtherSettingIndicator(getContext(), R.drawable.ic_menu_overflow,
					otherSettingKeys);
		}
	}
	...
	public void setEnabled(boolean enabled) {
		...
		if (mCameraPicker != null) {
			...
			if (mCurrentMode == MODE_VIDEO) {
				mCameraPicker.setVisibility(enabled ? View.VISIBLE
						: View.INVISIBLE);
			}
		}
	}
