...
// window.
public class IndicatorButton extends AbstractIndicatorButton implements
		BasicSettingPopup.Listener, EffectSettingPopup.Listener {
	...
	protected void initializePopup() {
		...
		ViewGroup root = (ViewGroup) getRootView().findViewById(
				R.id.frame_layout);
