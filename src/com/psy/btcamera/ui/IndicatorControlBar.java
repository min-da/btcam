...
public class IndicatorControlBar extends IndicatorControl implements
	...
	public void onClick(View view) {
		...
		mOnIndicatorEventListener
				.onIndicatorEvent(OnIndicatorEventListener.EVENT_ENTER_SECOND_LEVEL_INDICATOR_BAR);
	}
	...
	protected void onLayout(boolean changed, int left, int top, int right,
		...
		if (mZoomControl != null) {
			mZoomControl
					.layout(padding + size, 0, width - padding - size, size);
		}

		if (mCameraPicker != null) {
			mCameraPicker.layout(width - padding - size, 0, width - padding,
					size);
		}
	}
