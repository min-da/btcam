...
import com.psy.btcamera.CameraPreference.OnPreferenceChangedListener;
 ...
 * IndicatorControlBar, SecondIndicatorControlBar and ZoomControlBar for Phone
 * UI.
 */
public class IndicatorControlBarContainer extends IndicatorControlContainer {
	...
	public IndicatorControlBarContainer(Context context, AttributeSet attrs) {
		...
		mFadeIn = AnimationUtils.loadAnimation(context,
				R.anim.first_level_fade_in);
		mFadeOut = AnimationUtils.loadAnimation(context,
				R.anim.first_level_fade_out);
		mFadeOut.setAnimationListener(mAnimationListener);
		mSecondLevelFadeIn = AnimationUtils.loadAnimation(context,
				R.anim.second_level_fade_in);
		mSecondLevelFadeOut = AnimationUtils.loadAnimation(context,
				R.anim.second_level_fade_out);
	...
	protected void onFinishInflate() {
		...
		mSecondLevelIndicatorControlBar = (SecondLevelIndicatorControlBar) findViewById(R.id.second_level_indicator_bar);
